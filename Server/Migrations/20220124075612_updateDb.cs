        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerPrefValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewOnCustomers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewOnCustomers_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReviewOnCustomers_Meetings_MeetingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewOnCustomers_CustomerId",
                table: "ReviewOnCustomers",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewOnCustomers_MeetingId",
                table: "ReviewOnCustomers",
                column: "MeetingId");
        }
